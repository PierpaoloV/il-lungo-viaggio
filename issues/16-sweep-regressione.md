...
## Acceptance criteria
- [x] Conditionals di p14/p15 coerenti con la nuova struttura
- [x] Test aggiornati: `prologo.curiosita`, `terminalTopics`, `prologo.quotidianoA`, `terminalApp`
- [x] `npm test` verde
- [x] Nessun ramo morto o VAR orfana
